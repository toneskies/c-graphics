...
mat4_t mat4_make_rotation_y(float angle) {
    float c = cos(angle);
    float s = sin(angle);
    // flipped the sign for the "s" on the diagonal to preserve handedness
    // | c  0  s 0 |
    // | 0  1  0 0 |
    // |-s  0  c 0 |
    // | 0  0  0 1 |
...
mat4_t mat4_make_orthographic(float left, float right, float bottom, float top,
